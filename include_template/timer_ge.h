...
namespace GE {
    ...
    class Timer
    {
        ...
        private:
            ...
            int offset;
            util::timestamp ts;
            util::timestamp ts_beg;
            util::timestamp ts_end;
            util::timestamp ts_elapsed;
    ...
    class TimerList : public std::map<std::string, GE::Timer*>
    {
        public: 
            virtual ~TimerList() { 
                if (!this->empty()) {
            ...
            bool contains (std::string timer_name) { 
                std::map<std::string, GE::Timer*>::iterator iter = this->find(timer_name);
                if ( this->end() != iter ) {
                    return true; 
                } 
                return false; 
            ...
            virtual void clear() {
                ...
                std::map<std::string, GE::Timer*>::clear();
            }
    };
